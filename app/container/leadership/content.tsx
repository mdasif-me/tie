  ...
  return (
    <div data-animate='copy'>
      <div className='lg:space-y-5 md:space-y-3 space-y-2 max-w-xl'>
        ...
        <p
          className='lg:text-lg md:text-base text-sm font-medium lg:-mt-4 -mt-2'
          data-animate='item'
        >
          (Founder & CEO){' '}
        </p>
        <ul className='md:space-y-4 space-y-2 py-4'>
          <li className='md:text-lg sm:text-sm text-xs' data-animate='item'>
          ...
          <li
            className='md:text-lg sm:text-sm text-xs font-medium'
            data-animate='item'
          >
