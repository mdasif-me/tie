  ...
  return (
    <div data-animate='copy'>
      <div className='lg:space-y-5 md:space-y-3 space-y-2 max-w-xl'>
        ...
        <h1
          className='lg:text-4xl md:text-3xl text-2xl font-bold md:leading-12'
          data-animate='item'
        >
          Who We’re Built For{' '}
        </h1>
        <p
          className='lg:text-lg md:text-base text-sm font-medium md:leading-6'
          data-animate='item'
        >
        ...
        <ul className='md:space-y-4 space-y-2 py-4'>
          <li
            className='md:text-lg sm:text-sm text-xs flex items-center md:font-bold font-medium'
            data-animate='item'
          >
